...
Scrolling: Scrolling.cpp SDLImage.hpp SDLImage.cpp SDL_Wrapper.hpp SDL_Wrapper.cpp
	g++ -o Scrolling SDLImage.cpp Scrolling.cpp SDL_Wrapper.cpp -lSDL -lSDL_image
