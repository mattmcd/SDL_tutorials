...
Scrolling: Scrolling.cpp SDLImage.hpp SDLImage.cpp SDL_Wrapper.hpp SDL_Wrapper.cpp Camera.hpp StepCamera.hpp StepCamera.cpp
	g++ -o Scrolling SDLImage.cpp Scrolling.cpp SDL_Wrapper.cpp StepCamera.cpp -lSDL -lSDL_image
